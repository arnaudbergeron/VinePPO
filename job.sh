...
APP_DIRECTORY="$SCRATCH/vine/experiments/mixed_adv_clipped_adv" #change in file

export APP_SEED="2746318213"

export WANDB_RUN_ID="mixed_adv_clipped_adv" # Optional
