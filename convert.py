...
def convert_multi(
    ...
    filename = '/network/scratch/a/arnaud.bergeron1/llama8bgsm_mixed_rwds/16_samples_per_episodes_ppo/hf_pretrained/pytorch_model.bin.index.json'
    ...
    for filename in filenames:
        pt_filename = f'/network/scratch/a/arnaud.bergeron1/llama8bgsm_mixed_rwds/16_samples_per_episodes_ppo/hf_pretrained/{filename}'
...
def convert_single(
    ...
    pt_filename = hf_hub_download(
        repo_id=model_id, revision=revision, filename="16_samples_per_episodes_model/hf_pretrained/pytorch_model.bin", token=token, cache_dir=folder
    )
